...
These files are byte-level or pixel-level references extracted from the archived
...
and S8 are checked by documented pixel tolerances because supported re-encoding
