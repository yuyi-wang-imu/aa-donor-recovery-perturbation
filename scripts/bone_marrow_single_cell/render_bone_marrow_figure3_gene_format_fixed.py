...
def main() -> None:
    ...
    ax_b.set_title(
        "Participant-by-timepoint median compartment fractions",
        loc="left",
        fontsize=8.2,
        fontweight="bold",
        pad=4,
    ...
    status_labels = {
        ...
        "exclude_instability_below_8_of_9": "<8/9",
    }
    for row, module in enumerate(modules):
        ...
        text_status = f"{int(record['n_variants_agree_top1'])}/9  {status_labels[decision]}"
    ...
    stem = args.output_dir / "Figure_3_bone_marrow_atlas_gene_format_fixed_20260726"
