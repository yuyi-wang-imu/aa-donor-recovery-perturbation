...
panel_a_path <- file.path(output_dir, "Figure2A_panel_label_termfix_v5_20260726.png")
panel_b_path <- file.path(output_dir, "Figure2B_panel_label_termfix_v5_20260726.png")
subtitle_c_path <- file.path(output_dir, "Figure2C_subtitle_pvalue_v5_20260726.png")
combined_path <- file.path(output_dir, "Figure2_full_panel_label_pvalue_format_v5_20260726.png")
