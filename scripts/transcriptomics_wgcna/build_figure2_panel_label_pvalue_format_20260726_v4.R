...
group_summary_path <- normalizePath(args[[1L]], winslash = "/", mustWork = TRUE)
correlation_path <- normalizePath(args[[2L]], winslash = "/", mustWork = TRUE)
priority_path <- normalizePath(args[[3L]], winslash = "/", mustWork = TRUE)
current_figure_path <- normalizePath(args[[4L]], winslash = "/", mustWork = TRUE)
output_dir <- normalizePath(args[[5L]], winslash = "/", mustWork = TRUE)
...
panel_a_path <- file.path(output_dir, "Figure2A_panel_label_termfix_v4_20260726.png")
panel_b_path <- file.path(output_dir, "Figure2B_panel_label_termfix_v4_20260726.png")
subtitle_c_path <- file.path(output_dir, "Figure2C_subtitle_pvalue_v4_20260726.png")
combined_path <- file.path(output_dir, "Figure2_full_panel_label_pvalue_format_v4_20260726.png")
