...
if (length(args) != 2L) {
  stop(
    "Usage: Rscript build_figure8_standard_and_s11_sensitivity_candidate_v4.R ",
...
main_stem <- file.path(
  figure_dir,
  "Figure_8_standard_scTenifoldKnk_network_responses_pvalue_format_20260726_v11"
)
supp_stem <- file.path(
  figure_dir,
  "Supplementary_Figure_S11_matched_control_sensitivity_pvalue_format_20260726_v5"
)
