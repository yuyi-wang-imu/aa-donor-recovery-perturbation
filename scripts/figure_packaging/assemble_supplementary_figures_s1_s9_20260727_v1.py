"""Assemble the final nine-page supplementary-figure package.

This is a packaging-only workflow. It renumbers accepted one-page PDF assets
after removal of panels that duplicate the main figures. It does not read or
...
def main() -> None:
    ...
    parser.add_argument(
        "input_dir",
        type=Path,
        help="Directory containing the nine accepted one-page PDF assets.",
    )
    ...
    source_names = [
        ...
        "Supplementary_Figure_S7_NetworkDetails_20260726.pdf",
        "Supplementary_Figure_S8_DockingMatrixOnly_20260726.pdf",
        "Supplementary_Figure_S9_MatchedControlSensitivity_20260726.pdf",
    ]

    args.output_dir.mkdir(parents=True, exist_ok=True)
    combined_path = args.output_dir / "Supplementary_Figures_S1-S9.pdf"
    archive_path = args.output_dir / "Supplementary_Figures_S1-S9_Independent_PDFs.zip"
    manifest_path = args.output_dir / "Supplementary_Figures_S1-S9_manifest.json"
    ...
    if len(PdfReader(str(combined_path)).pages) != 9:
        raise RuntimeError("Combined supplementary PDF must contain nine pages.")
