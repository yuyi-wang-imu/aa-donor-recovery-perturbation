#!/usr/bin/env python3
"""Final spacing pass for the five-complex long-axis 100-ns MD figures.

V5 changes only layout relative to v4: the legend band is separated further
from panels A-B, panel letters sit inside their panel margins, and the fourth
matrix-column heading is shortened to prevent right-edge clipping.
"""
